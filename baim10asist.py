...
kk = SINGLEKILLER.LINE()
#kk.login(qr=True)
kk.login(token=
kk.loginResult()
print "Kk-Login Success\n"

kc = SINGLEKILLER.LINE()
#kc.login(qr=True)
kc.login(token=
kc.loginResult()
print "Kc-Login Success\n"

kr = SINGLEKILLER.LINE()
#kr.login(qr=True)
kr.login(token=
kr.loginResult()

ks = SINGLEKILLER.LINE()
#ks.login(qr=True)
ks.login(token=
ks.loginResult()

ka = SINGLEKILLER.LINE()
#ka.login(qr=True)
ka.login(token=
ka.loginResult()

kb = SINGLEKILLER.LINE()
#kb.login(qr=True)
kb.login(token=
kb.loginResult()

ko = SINGLEKILLER.LINE()
#ko.login(qr=True)
ko.login(token=
ko.loginResult()

ke = SINGLEKILLER.LINE()
#ke.login(qr=True)
ke.login(token="
ke.loginResult()
print "Kr-Login Success\n"

km = SINGLEKILLER.LINE()
#km.login(qr=True)
km.login(token="
km.loginResult()
print """
...
KAC=[cl,ki,kk,kc,kr,ks,ka,kb,ko,ke]
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Dmid,Emid,Fmid,Gmid,Hmid,Imid]
Creator=["u03625388921e6baa1e0fc85003b8fdef"]
admin=["u8e33f7ffd36a68bf406db10305f1af09"]
...
responsename7 = ka.getProfile().displayName
responsename8 = kb.getProfile().displayName
responsename9 = ko.getProfile().displayName
...
def bot(op):
    try:
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Name = kb.getContact(op.param2).displayName
                            Name = ko.getContact(op.param2).displayName
	    ...
	    if mid in op.param3:
            ...
            ka.acceptGroupInvitationByTicket(op.param1,Ti)
            kb.acceptGroupInvitationByTicket(op.param1,Ti)
            ko.acceptGroupInvitationByTicket(op.param1,Ti)                 ke.acceptGroupInvitationByTicket(op.param1,Ti)
			ke.acceptGroupInvitationByTicket(op.param1,Ti)
            G.preventJoinByTicket = True
			cl.updateGroup(G)
			cl.sendText(op.param1,"☆Ketik ☞Help☜ Untuk Bantuan☆\n☆Harap Gunakan Dengan Bijak ^_^ ☆")
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u03625388921e6baa1e0fc85003b8fdef"
                admin2 = "u8e33f7ffd36a68bf406db10305f1af09"
                admin3 = "ue9474acfc84b8d5fcb7cca3d98dc40af"
                msg.contentMetadata = {'mid': tjia}
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		try:
            ...
            elif msg.text in ["Absen","Sk absen]:
        if msg.from_ in admin:
		cl.sendText(msg.to,"SK Absen!!")
                ki.sendText(msg.to,"︻╦̵̵͇̿╤───")
                kk.sendText(msg.to,"︻╦̵̵͇̿╤───")
                kc.sendText(msg.to,"︻╦̵̵͇̿╤───")
                kr.sendText(msg.to,"︻╦̵̵͇̿╤───")
                ks.sendText(msg.to,"︻╦̵̵͇̿╤───")
                ka.sendText(msg.to,"︻╦̵̵͇̿╤───")
                kb.sendText(msg.to,"︻╦̵̵͇̿╤───")
                ko.sendText(msg.to,"︻╦̵̵͇̿╤───")
                ke.sendText(msg.to,"Hadiir Semua Komandan")
        ...
        if msg.from_ in admin:
                ...
                ka.sendText(msg.to,responsename7)
                kb.sendText(msg.to,responsename8)
                ko.sendText(msg.to,responsename9)
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
            ...
            elif "TC5 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TC5 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ks.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TC6 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TC6 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ka.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TC7 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TC7 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kb.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               kb.sendText(msg.to, "Copied (^_^)")
                            except Exception as e:
                                print e

            elif "TC8 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TC8 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ko.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       if _nametarget == g.displayName:
                           targets.append(g.mid)
                   if targets == []:
                       ko.sendText(msg.to, "Not Found...")
                   else:
                       for target in targets:
                            try:
                               ko.CloneContactProfile(target)
                               ko.sendText(msg.to, "Copied (^_^)")
                            except Exception as e:
                                print e

            elif "TC9 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TC9 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ke.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    ka.updateDisplayPicture(backup7.pictureStatus)
                    ka.updateProfile(backup7)
                    
                    kb.updateDisplayPicture(backup8.pictureStatus)
                    kb.updateProfile(backup8)
                    
                    ko.updateDisplayPicture(backup9.pictureStatus)
                    ko.updateProfile(backup9)
                    
                    ke.updateDisplayPicture(backup10.pictureStatus)
		...
		if msg.from_ in Creator:
            ...
            elif "/cntc5" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc5","Chucky TC5")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntc6" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc6","Chucky TC6")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntc7" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc7","Chucky TC7")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntc8" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc8","Chucky TC8")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntc9" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc9","Chucky TC9")
                    if len(string.decode('utf-8')) <= 5000:
...
#              if msg.from_ in admin:
            ...
            elif msg.text in ["TC5 acc invite"]:
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            ...
                            break
                    if gid is not None:
                        ks.sendText(msg.to,"Berhasil terima semua undangan dari grup :\n" + _list)
                    else:
                        ks.sendText(msg.to,"Tidak ada grup yang tertunda saat ini")

            elif msg.text in ["TC6 acc invite"]:
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            gids = ka.getGroup(i)
                            _list += gids.name
                            ka.acceptGroupInvitation(i)
                        else:
                            break
                    if gid is not None:
                        ka.sendText(msg.to,"Berhasil terima semua undangan dari grup :\n" + _list)
                    else:
                        ka.sendText(msg.to,"Tidak ada grup yang tertunda saat ini")

            elif msg.text in ["TC7 acc invite"]:
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            ...
                            break
                    if gid is not None:
                        kb.sendText(msg.to,"Berhasil terima semua undangan dari grup :\n" + _list)
                    else:
                        kb.sendText(msg.to,"Tidak ada grup yang tertunda saat ini")

            elif msg.text in ["TC8 acc invite"]:
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            gids = ko.getGroup(i)
                            _list += gids.name
                            ko.acceptGroupInvitation(i)
                        else:
                            break
                    if gid is not None:
                        ko.sendText(msg.to,"Berhasil terima semua undangan dari grup :\n" + _list)
                    else:
                        ko.sendText(msg.to,"Tidak ada grup yang tertunda saat ini")

            elif msg.text in ["TC9 acc invite"]:
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            gids = ke.getGroup(i)
                            _list += gids.name
                            ke.acceptGroupInvitation(i)
                        else:
                            break
                    if gid is not None:
                        ke.sendText(msg.to,"Berhasil terima semua undangan dari grup :\n" + _list)
                    else:
                        ke.sendText(msg.to,"Tidak ada grup yang tertunda saat ini")    
