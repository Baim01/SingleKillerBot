...
Imid = km.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Dmid,Emid,Fmid,Gmid,Hmid,]
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		cl.sendText(msg.to,"SK Absen!!")
                ...
                ko.sendText(msg.to,"Hadiir Semua Komandan")
